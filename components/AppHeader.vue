<template>
  <nav class="w-full p-6 bg-transparent sticky z-50">
    <div class="flex items-center justify-between mx-auto">
      ...
      <div class="hidden md:block mx-auto">
        <ul class="flex space-x-8 text-sm font-sans">
          ...
          <li v-for="(item, index) in navigationItems" :key="index">
            <a :href="item.link" :class="{ active: index === activeIndex }">{{
              item.label
            }}</a>
          </li>
          <li>
      ...
      <aside
        ...
        <ul class="divide-y font-sans">
          <li v-for="(item, index) in navigationItems" :key="index">
            <a class="my-4 inline-block" :href="item.link" :class="{ active: index === activeIndex }">{{ item.label }}</a>
          </li>
        </ul>
        <div class="follow">
