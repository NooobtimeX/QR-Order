<template>
  <div>
    <div class="isolate bg-white px-6 py-16">
      <!-- หัว-->
      ...
      <form action="#" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
        <h3 class="text-lg font-semibold text-black">Contact Information</h3>
        <!-- ฟอร์มคอนแทค-->
        ...
        <h3 class="text-lg font-semibold text-black pt-4">
        ...
        <div>
          <div>
            <p class="text-lg font-semibold text-black">
              เลือกรูปแบบร้านอาหารของคุณ
            </p>
            <input type="radio" id="" name="" value="" />
            <label for="html" class="text-sm font-semibold leading-6 text-black"
              >ร้านอาหาร</label
            ><br />
            <input type="radio" id="" name="f" value="" />
            <label for="css" class="text-sm font-semibold leading-6 text-black"
              >ร้านบุฟเฟต์</label
            ><br />
          </div>
          <div>
