<template>
    ...
    <div class="flex items-center">
        <img src="/logo/test.png" alt="teenoi" class="h-28 w-28" />

        <div class="flex flex-col items-center pl-6"> <!-- Use flex-col to arrange items vertically -->
            <h1 class="text-2xl mt-4">Suki Teenoi</h1>
    ...
    <!-- คอมเม้น -->
    <div>
        <div class="border border-gray-300 p-4 rounded-lg max-w-xl mx-auto mt-40 h-96 w-72">
